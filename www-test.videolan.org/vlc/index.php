...
?>
			...
			<div style='clear: both; padding-top: 70px;'>
				...
				<div style='float: left; width: 500px;'>
					...
					<a class='extraInfoLink' href='#'>Features</a>
			...
			<div style='clear: both; padding-top: 90px;'>
				...
				<div style='float: right; width: 450px; padding-left: 70px;'>
					...
					<a class='red' style='display: block; padding-top: 10px; padding-left: 5px; font-size: 12px;' href='#'>view all screenshots</a>
				</div>
			</div>
			<div style='clear: both; padding-top: 60px; color: #333333;'>
				<div style='float: left; width: 300px; padding-right: 40px;'>
					<h1 class='red' style='padding-bottom: 20px;'>Heading One</h1>
				...
				<div style='float: left; width: 300px; padding-right: 40px;'>
					<h1 class='red' style='padding-bottom: 20px;'>Heading Two</h1>
					Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse euismod commodo suscipit.<br />
					<br />
					Nulla ultrices nisl id turpis egestas fermentum. Nunc egestas lacus sit amet metus tincidunt imperdiet. Donec euismod scelerisque diam, a egestas quam pretium non. Phasellus auctor elit non diam facilisis luctus. Sed id justo quis felis aliquam ullamcorper.<br />
				...
				<div style='float: left; width: 300px;'>
					<h1 class='red' style='padding-bottom: 20px;'>Heading Three</h1>
					Nulla ultrices nisl id turpis egestas fermentum. Nunc egestas lacus sit amet metus tincidunt imperdiet. Donec euismod scelerisque diam, a egestas quam pretium non. Phasellus auctor elit non diam facilisis luctus. Sed id justo quis felis aliquam ullamcorper.<br />
