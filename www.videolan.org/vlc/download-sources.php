...
<p> Latest VLC source code tarball (0.8.6b): </p>

<ul class="bullets">
<li>
  <?php  pkgitem_nomirr("VLC source code tar.gz", "0.8.6b","vlc-0.8.6b.tar.gz","vlc");?></li>
<li><?php pkgitem_nomirr("VLC source code tar.bz2", "0.8.6b","vlc-0.8.6b.tar.bz2","vlc"); ?></li>
</ul>

<h2> Latest required libraries: </h2>
<p>
The list of required libraries is not yet updated for 0.8.6b
</p>
...
<li><?php     pkgitem_nomirr("flac 1.1.2", "0.8.5/contrib","flac-1.1.2.tar.gz","vlc","(FLAC audio codec)");?></li>
...
<li><?php     pkgitem_nomirr("libogg 1.1.2", "0.8.5/contrib","libogg-1.1.2.tar.gz","vlc","(Ogg library)");?></li>
