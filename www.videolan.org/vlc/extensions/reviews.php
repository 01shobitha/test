...
if(isset($getId)) {
	...
	if($totalRows_topReviews>0) { ?>
		...
		<?php do { ?>
			<div>
				<span><?php if(isset($row_topReviews['url'])) echo '<a href="'.$row_topReviews['url'].'" target="_blank" rel="noopener">'.$row_topReviews['name'].'</a>'; else echo $row_topReviews['name']; ?></span> | 
	...
	<?php }	if($totalRows_reviews>0) {
		do { ?>
			<div>
				<span><?php if(isset($row_reviews['url'])) echo '<a href="'.$row_reviews['url'].'" target="_blank" rel="noopener">'.$row_reviews['name'].'</a>'; else echo $row_reviews['name']; ?></span> | 
