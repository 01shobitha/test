...
<h2>Latest Mac OS X package for 10.3.9, 10.4 and 10.5 (release 0.8.6g)</h2>

<?php pkgitem( "Universal Binary",
               "0.8.6g/macosx","vlc-0.8.6g.dmg","vlc"); ?>

<h2>Platform specific packages for 10.3.9, 10.4 and 10.5 (release 0.8.6g)</h2>

<?php pkgitem( "Intel package",
               "0.8.6g/macosx","vlc-0.8.6g-intel.dmg","vlc"); ?>

<?php pkgitem( "PowerPC package",
               "0.8.6g/macosx","vlc-0.8.6g-powerpc.dmg","vlc"); ?>

<h2>Web browser plugins for 10.3.9, 10.4 and 10.5 (release 0.8.6g)</h2>

<?php pkgitem( "Web Browser plugin for Intel",
               "0.8.6g/macosx","vlc-plugin-0.8.6g-intel.dmg","vlc"); ?>

<?php pkgitem( "Web Browser plugin for PowerPC",
               "0.8.6g/macosx","vlc-plugin-0.8.6g-powerpc.dmg","vlc"); ?>
