...
function DoDL2( $os, $with_js=1 )
{
    ...
    $dl["Win32"] = array( "$start_url/win32/vlc-1.1.0-win32.exe", "Windows install" );
    $dl["Win32-7z"] = array( "$start_url/win32/vlc-1.1.0-rc-win32.7z", "Windows 7z" );
...
<h3>Source</h3>
<a href="<?php echo getDownloadLink("vlc", "1.1.0", "vlc-1.1.0.tar.bz2"); ?>">VLC Source download</a>
<h3>Win32</h3>
<a href="<?php echo getDownloadLink("vlc", "1.1.0", "win32/vlc-1.1.0-win32.exe"); ?>">VLC Win32 installer</a><br />
<a href="<?php echo getDownloadLink("vlc", "1.1.0", "win32/vlc-1.1.0-win32.7z"); ?>">VLC Win32 7zip (no install)</a><br />
<a href="<?php echo getDownloadLink("vlc", "1.1.0", "win32/vlc-1.1.0-win32.zip"); ?>">VLC Win32 zip (no install)</a><br />
<h3>MacOS</h3>
<a href="<?php echo getDownloadLink("vlc", "1.1.0", "macosx/vlc-1.1.0.dmg"); ?>">Universal Binary for Intel</a><br />
