...
function get_first_bar_item ( $number , $module , $text , $url , $current_module ) {
  ...
  {
     ?><td class="firstbarselected" style="width: <? echo printf ( "%i" , 100/$number ); ?>%"><? echo $text; ?></td>
     <?
  }
  else
  {
     ?><td class="firstbar" style="width: <? echo printf ( "%i" , 100/$number ); ?>%"><a class="firstbar" href="<? echo $url; ?>"><? echo $text; ?></a></td>
     <?
  }
}
