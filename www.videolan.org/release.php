...
<div id="maincontent">
  ...
  <div id="download">
        <script type="text/javascript"><!--
            if ( navigator.platform.indexOf("Win32") != -1 ) { document.writeln( '<p><a class="download" href="/mirror-geo.php?file=vlc/0.9.9/win32/vlc-0.9.9-win32.exe">Download Now</a> for Windows (16 MB)</p>'); }
            ...
            {
              if( navigator.platform.indexOf("MacPPC") != -1|| navigator.platform.indexOf("PowerPC") != -1 ) { document.writeln( '<p><a class="download" href="/mirror-geo.php?file=vlc/0.9.9a/macosx/vlc-0.9.9a-powerpc.dmg">Download Now</a> for Mac OS X PowerPC (19 MB)</p>'); }
              else if( navigator.platform.indexOf("Intel") != -1 ) { document.writeln( '<p><a class="download" href="/mirror-geo.php?file=vlc/0.9.9a/macosx/vlc-0.9.9a-intel.dmg">Download Now</a> for Mac OS X Intel (19 MB)</p>');}
                 else  { document.writeln( '<p><a class="download" href="/mirror-geo.php?file=vlc/0.9.9a/macosx/vlc-0.9.9a-powerpc.dmg">Download Now</a> for Mac OS X PowerPC (19 MB)</p>');document.writeln( '<p><a class="download" href="/mirror-geo.php?file=vlc/0.9.9a/macosx/vlc-0.9.9a-intel.dmg">Download Now</a> for Mac OS X Intel (19 MB)</p>'); }
            }
            ...
            {
            document.writeln( '<p><a class="download" href="/mirror-geo.php?file=vlc/0.9.9/win32/vlc-0.9.9-win32.exe">Download Now</a> for Windows (16 MB)</p>');document.writeln( '<p><a class="download" href="/mirror-geo.php?file=vlc/0.9.9a/macosx/vlc-0.9.9a-powerpc.dmg">Download Now</a> for Mac OS X PowerPC (19 MB)</p>');document.writeln( '<p><a class="download" href="/mirror-geo.php?file=vlc/0.9.9a/macosx/vlc-0.9.9a-intel.dmg">Download Now</a> for Mac OS X Intel (19 MB)</p>');            }
       --></script>
       <noscript>
          <p><a class="download" href="/mirror-geo.php?file=vlc/0.9.9/win32/vlc-0.9.9-win32.exe">Download Now</a> for Windows (16 MB)</p><p><a class="download" href="/mirror-geo.php?file=vlc/0.9.9a/macosx/vlc-0.9.9a-powerpc.dmg">Download Now</a> for Mac OS X PowerPC (19 MB)</p><p><a class="download" href="/mirror-geo.php?file=vlc/0.9.9a/macosx/vlc-0.9.9a-intel.dmg">Download Now</a> for Mac OS X Intel (19 MB)</p>       </noscript>
