...
<div style="text-shadow: 0px 3px 4px #666666; color:#333333; font-family: Helvetica, Arial, sans-serif; font-size:40px; font-weight:bold; margin: 20px;">VLC 1.1.7</div>
...
<h3>Source</h3>
<a href="<?php echo getDownloadLink("vlc", "1.1.7", "vlc-1.1.7.tar.bz2"); ?>">VLC Source download</a>
<h3>Win32</h3>
<a href="<?php echo getDownloadLink("vlc", "1.1.7", "win32/vlc-1.1.7-win32.exe"); ?>">VLC Win32 installer</a><br />
<a href="<?php echo getDownloadLink("vlc", "1.1.7", "win32/vlc-1.1.7-win32.7z"); ?>">VLC Win32 7zip (no install)</a><br />
<a href="<?php echo getDownloadLink("vlc", "1.1.7", "win32/vlc-1.1.7-win32.zip"); ?>">VLC Win32 zip (no install)</a><br />
<h3>MacOSX</h3>
<br />
<h3>Press contact</h3>
