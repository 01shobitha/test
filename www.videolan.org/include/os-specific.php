<?php
   ...
   function Screenshot( $os )
    ...
    {
	$dl = array();
	$dl["Win32"] = array("/mirror-geo.php?file=vlc/0.9.8a/win32/vlc-0.9.8a-win32.exe", "Windows (16 MB)" );
	$dl["OSX-PPC"] = array("/mirror-geo.php?file=vlc/0.9.8a/macosx/vlc-0.9.8a-powerpc.dmg", "Mac OS X PowerPC (18 MB)" );
	$dl["OSX-Intel"] = array( "/mirror-geo.php?file=vlc/0.9.8a/macosx/vlc-0.9.8a-intel.dmg","Mac OS X Intel (18 MB)" );
