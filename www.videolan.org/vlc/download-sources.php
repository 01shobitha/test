...
<p> Latest VLC source code tarball (1.1.3): </p>

<ul class="bullets">

<li><a href="http://sourceforge.net/projects/vlc/files/1.1.3/vlc-1.1.3.tar.bz2/download">VLC source code tar.bz2</a>
...
<li><?php     pkgitem_nomirr("flac 1.1.3", "0.8.5/contrib","flac-1.1.3.tar.gz","vlc","(FLAC audio codec)");?></li>
...
<li><?php     pkgitem_nomirr("libogg 1.1.3", "0.8.5/contrib","libogg-1.1.3.tar.gz","vlc","(Ogg library)");?></li>
