<?php
    ...
    $request = pg_query($connect, "select sum(number) from (select * from mirrors where file like '%0.8.6%' union select * from mirrors_archive where file like '%0.8.6%') as allmirrors;" );
