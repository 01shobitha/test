...
function DoDL( $os, $with_js=1 )
{
    ...
    $dl["OSX-PPC"] = array("http://sourceforge.net/projects/vlc/files/$version_back/macosx/vlc-$version_back-powerpc.dmg/download", "Mac OS X 10.5 (PowerPC), 25&nbsp;MB" );
