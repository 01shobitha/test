...
?>
        ...
        <div class="clearme" style='padding-top: 35px;'>
            ...
            <div style='float: left; width: 500px;'>
                <h1 class='bigtitle'>VLC 1.1.10</h1>
...
<h1>What was new in 1.1.10</h1>
<p>Two months after VLC 1.1.9, we present you a minor release of VLC.</p>
<p>Fixing important bugs and security issues, here is <b>VLC 1.1.10</b>.</p>

<br />
<div style="float:left; width: 48%;">
<ul class="blue-bullet">
<li>Security update regarding an integer overflow in xspf demuxer</li>
<li>Rewrite of the pulseaudio audio output module</li>
...
<ul class="blue-bullet">
<li>Removal of the font-cache re-building on the freetype module on Windows</li>
<li>Numerous updates and fixes on the interface and look of VLC for Mac OS X</li>
<li>Many miscellaneous fixes in decoders, demuxers and subtitles</li>
<li>3rd party libraries updates</li>
</ul>
</div>
<div style="clear: both;"></div>

<h1>What was new in 1.1.9</h1>
...
<h1>What was new in 1.1.6 and 1.1.7</h1>
...
<h3>Source</h3>
<a href="<?php echo getDownloadLink("vlc", "1.1.10", "vlc-1.1.10.tar.bz2"); ?>">VLC Source download</a>
<h3>Win32</h3>
<a href="<?php echo getDownloadLink("vlc", "1.1.10", "win32/vlc-1.1.10-win32.exe"); ?>">VLC Win32 installer</a><br />
<a href="<?php echo getDownloadLink("vlc", "1.1.10", "win32/vlc-1.1.10-win32.7z"); ?>">VLC Win32 7zip (no install)</a><br />
<a href="<?php echo getDownloadLink("vlc", "1.1.10", "win32/vlc-1.1.10-win32.zip"); ?>">VLC Win32 zip (no install)</a><br />
<h3>MacOSX</h3>
<br />
<h3>Press contact</h3>
