<?php
   ...
   function Screenshot( $os )
    ...
    {
	$dl = array();
	$dl["Win32"] = array("/mirror.php?file=vlc/0.8.6a/win32/vlc-0.8.6a-win32.exe", "Windows (9 MB)" );
	$dl["OSX-PPC"] = array("/mirror.php?file=vlc/0.8.6a/macosx/vlc-0.8.6a-powerpc.dmg", "MacOS X PowerPC (14 MB)" );
	$dl["OSX-Intel"] = array( "/mirror.php?file=vlc/0.8.6a/macosx/vlc-0.8.6a-intel.dmg","MacOS X Intel (13 MB)" );
