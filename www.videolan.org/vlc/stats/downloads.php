...
<?php    echo "<center><img src='//images1.videolan.org/images/events/1billion.png' alt='1 billion downloads' class='' style='box-shadow: 0px 0px 10px 5px #FFF; margin-top: 20px;' /></center>"; ?>
    ...
    $table = array( "1.1.0"   => array( "Windows" => 15352734,  "Macintosh" => 2538263, "Total" => 17940200 ),
                    ...
                    "2.0.1"   => array( "Windows" => 53672851,  "Macintosh" => 5581139, "Total" => 59283002 ),
    );
