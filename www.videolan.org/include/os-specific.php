<?php
   ...
   function Screenshot( $os )
    ...
    {
	$dl = array();
	$dl["Win32"] = array("/mirror.php?file=vlc/0.8.6/win32/vlc-0.8.6-win32.exe", "Windows (9 MB)" );
	$dl["OSX-PPC"] = array("/mirror.php?file=vlc/0.8.6/macosx/vlc-0.8.6-powerpc.dmg", "MacOS X PowerPC (14 MB)" );
	$dl["OSX-Intel"] = array( "/mirror.php?file=vlc/0.8.6/macosx/vlc-0.8.6-intel.dmg","MacOS X Intel (13 MB)" );
