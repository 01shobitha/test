...
?>
    <div>
            <center><h1 class='bigtitle' style="padding-bottom: 3px;">VLC <b>2.2.3</b> "Weatherwax"</h1>
            <div style="padding-top: 0px; padding-bottom: 10px; color: grey;">VLC 2.2.3 is the third bugfix release of the "Weatherwax" branch of our popular media player.</div>
            </center>
    ...
    .subtext { position: relative; top: -20px; left:250px; width: 400px; text-align: center; }
        ...
        <h2 class="subtext" style="display: none;" id="text_6">Addons download from VLC</h2>
                ...
                <a id='downloadButton' href='#download' style="margin-left: 300px; margin-top: 0px;">
                    ...
                    Version <span id='downloadVersion'>2.2.3</span>
                    </span>
                </a>
                <script>
        ...
        <div class="clearme" style='padding-top: 30px;'>
            ...
            <h1 style='margin-bottom: 12px;'><?php echo _("2.2.3 Highlights"); ?></h1>
                <div class='projectDescription' style="width: 600px;">
                    <div style="padding-bottom: 8px;">VLC 2.2.3 <a href="https://wiki.videolan.org/VLC_CodeNames">"Weatherwax"</a> is the third update to VLC's 2.2 release series. </div>
                    <div>Notable number of improvements, like green lines in the Windows video output and resuming where you left off.</div>
                    <div>It also improves our codec support by adding new formats and providing faster decompression.</div>
                    <div>More than 30 fixes for issues reported for 2.2.2.</div>
                    <div>You can finally open more than 15 elements from the Windows' Explorer.</div>
