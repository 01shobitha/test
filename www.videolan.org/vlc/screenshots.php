...
echo"<div class='largescreenshot'><a href='http://images.videolan.org/vlc/screenshots/$img'>
    <img class='screenshot' style='width: 150px;' src='http://images.videolan.org/vlc/screenshots/$thumb' alt='VLC media player - $desc' /></a>
    <br />  $desc<br />($size) </div>";
}
?>
