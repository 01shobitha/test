<?php
   $title = "VideoLAN - Press Release - Server hosts change";
   $lang = "en";
   $menu = array( "vlc" );
...
<p>
VideoLAN is the software development project behind the open-source
VLC&nbsp;media&nbsp;player (VLC), a cross-platform media player and
