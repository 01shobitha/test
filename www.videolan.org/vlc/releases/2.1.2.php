...
?>
    <div>
            <center><h1 class='bigtitle' style="padding-bottom: 3px;">VLC reaches <b>2.1.2</b></h1>
            <div style="padding-top: 0px; padding-bottom: 10px; color: grey;">VLC 2.1.2 is the second minor version of our popular media player "Rincewind".</div>
            </center>
 ...
 body {
    ...
    .subtext { position: relative; top: -20px; left:300px; width: 300px; text-align: center; } 
        ...
        <div class="clearme" style='padding-top: 30px;'>
            ...
            <h1 style='margin-bottom: 12px;'><?php echo _("2.1.2 Highlights"); ?></h1>
                <div class='projectDescription'>
                    <div style="padding-bottom: 8px;">With the capabilities of "RinceWind", 2.1.2 allows experimental decoding of HEVC and Webm/VP9 (depending on the platform).
                         </div>
