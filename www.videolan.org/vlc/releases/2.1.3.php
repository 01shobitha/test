...
?>
    <div>
            <center><h1 class='bigtitle' style="padding-bottom: 3px;">VLC reaches <b>2.1.3</b></h1>
            <div style="padding-top: 0px; padding-bottom: 10px; color: grey;">VLC 2.1.3 is the third minor version of our popular media player "Rincewind".</div>
            </center>
 ...
 body {
    ...
    .subtext { position: relative; top: -20px; left:300px; width: 300px; text-align: center; } 
        ...
        <div class="clearme" style='padding-top: 30px;'>
            ...
            <h1 style='margin-bottom: 12px;'><?php echo _("2.1.3 Highlights"); ?></h1>
                <div class='projectDescription'>
                    <div style="padding-bottom: 8px;">With the capabilities of "RinceWind", 2.1.3 fixes numerous bugs, and improves decoders, notably for the new formats (HEVC and VP9)</div>
