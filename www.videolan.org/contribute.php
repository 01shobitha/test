...
here</a>. Current status of donnations is: 358,49&euro; donated ... much
more needed (lets say 431,51&euro;). Remember to mention that you are
donating money for the G5 in the donation comments.<br />

Status bar : <img src="/images/green-pix.png" style="border: 0px;
padding: 0px; margin:0px" height="10px" width="73px" alt="ok" /><img
src="/images/red-pix.png" style="border: 0px; padding: 0px; margin:0px"
height="10px" width="87px" alt="not ok" /> (green is what is already
