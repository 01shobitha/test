<?php
   ...
   $alternate_lang = array( "an", "ar", "ast", "be", "bn_IN", "bs", "ca", "cs", "cy", "da", "de", "el", "en", "es", "et", "fr", "gd", "gl", "gu", "he", "hi", "hr", "is", "it", "ja", "km", "kn", "ko", "ky", "lt", "mr", "my", "nb", "nl", "or", "pl", "pt", "pt_BR", "ro", "ru", "si", "sk", "sr", "sv", "te", "th", "tr", "uk", "ur", "vi", "wa", "zh", "zh_TW" );
