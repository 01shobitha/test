...
<p> Latest VLC source code tarball (0.8.6d): </p>

<ul class="bullets">
<li>
  <?php  pkgitem_nomirr("VLC source code tar.gz", "0.8.6d","vlc-0.8.6d.tar.gz","vlc");?></li>
<li><?php pkgitem_nomirr("VLC source code tar.bz2", "0.8.6d","vlc-0.8.6d.tar.bz2","vlc"); ?></li>
</ul>

<h2> Latest required libraries: </h2>
<p>
The list of required libraries is not yet updated for 0.8.6d
</p>
