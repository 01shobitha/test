<?php
   ...
   $win32version = "2.0.8";
?>
    <center><h1 class='bigtitle'>VLC reaches <b>2.0.8</b></h1>
    <div style="padding-top: 10px;">VLC 2.0.8 "Twoflower" is a small update to our 2.0 media player.</div>
    </center>
        ...
        <div class="clearme" style='padding-top: 30px;'>
            ...
            <div style='float: left; width: 500px;'>
                <div class='projectDescription'>
                    <div style="padding-bottom: 8px;"><b>2.0.8</b> is a small update that fixes some regressions of the 2.0.x branch of VLC.</b>

                    <div style="padding-bottom: 8px;"><b>2.0.8</b> fixes numerous crashes and dangerous behaviors.</div>

                    <div style="padding-bottom: 8px;"><b>2.0.8</b> also fixes ISDB-S tunning and some OSX issues.</div>
                ...
                <a id='downloadButton' href='#download'>
                    ...
                    Version <span id='downloadVersion'>2.0.8</span>
                    </span>
                </a>
                <script>
...
function vlcscreenshot($img,$thumb, $desc){
    echo"<div class='screenshot' style='overflow: hidden; width: 150px; height: 97px;'><a href='//images.videolan.org/vlc/screenshots/$img' rel='lightbox-vlc'><img
...
?>
        ...
        <div class="clearme"></div>
        <h1>2.0.8 specific changes</h1>

            <div style='float: left; width: 480px;'>
                <div class='audienceCallout'><?php echo _("2.0.8"); ?></div>
                <div class='clearme'>
                    <div class='productDescription'>
                        <ul>
                           <li>Fix ISDB-S tunning on Linux.</li>
                           <li>Fix crash in QTsound.</li>
                           <li>Fix use-after-free in sgimb module.</li>
                           <li>New Kannada translation.</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div style='float: left; width: 480px;'>
                ...
                <div class='clearme'>
                    <div class='productDescription'>
                        <ul>
                            <li>Fix crashes in libavcodec module.</li>
                            <li>Fix invalid memcpy in MMS access module.</li>
                            <li>Improve resitance against malformed MKV files.</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <p>
           <a href="https://www.facebook.com/vlc.media.player/posts/10151594070196245">Facebook</a>
           <a href="https://plus.google.com/b/104597325891170264649/+vlc/posts/9dxTddPHFyh">Google Plus</a>
           <a href="https://twitter.com/videolan/status/344046214582505475">Twitter</a>
           </p>
        <div class="clearme"></div>
        <h1>Download VLC</h1>
        <h2>Windows</h2>
