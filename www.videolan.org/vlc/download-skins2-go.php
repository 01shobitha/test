...
<html>
  <head>
    ...
    <meta http-equiv="refresh" content="0; url=http://download2.videolan.org/vlc/skins2/<?php echo $url; ?>" />
  </head>
  <body>
    <p>Click <a href="http://download2.videolan.org/vlc/skins2/<?php echo $url; ?>">here</a> if your download doesn't start.</p>
<?php
