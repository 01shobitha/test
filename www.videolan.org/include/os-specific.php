<?php
   ...
   function Screenshot( $os )
    {
	$scr = array();
	$scr["Win32"] = array( "http://download2.videolan.org/imagess/screenshots/vlc-win32.jpg" ,
			       "VLC on Windows", 300, 200 );
	$scr["Linux"] = array( "http://download2.videolan.org/imagess/screenshots/vlc-linux.jpg" ,
			       "VLC on Linux", 300, 233 );
	$scr["OSX"] = array( "http://download2.videolan.org/imagess/screenshots/vlc-osx.jpg" ,
