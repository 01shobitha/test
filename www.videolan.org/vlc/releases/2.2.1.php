<?php
   $title = _("VLC 2.2.1 Terry Pratchett (WeatherWax)");
   $body_color = "red";
   $language = "";
   $nobanner = true;
...
?>
    <div>
            <center><h1 class='bigtitle' style="padding-bottom: 3px;">VLC <b>2.2.1</b> "Terry Pratchett"</h1>
            <div style="padding-top: 0px; padding-bottom: 10px; color: grey;">VLC 2.2.1 is the first bugfix release of the "Weatherwax" branch of our popular media player.</div>
            </center>
    ...
    .subtext { position: relative; top: -20px; left:250px; width: 400px; text-align: center; }
        ...
        <h2 class="subtext" style="display: none;" id="text_6">Addons download from VLC</h2>
                ...
                <a id='downloadButton' href='#download' style="margin-left: 300px; margin-top: 0px;">
                    ...
                    Version <span id='downloadVersion'>2.2.1</span>
                    </span>
                </a>
                <script>
        ...
        <div class="clearme" style='padding-top: 30px;'>
            ...
            <h1 style='margin-bottom: 12px;'><?php echo _("2.2.1 Highlights"); ?></h1>
                <div class='projectDescription' style="width: 600px;">
                    <div style="padding-bottom: 8px;">VLC 2.2.1 <a href="https://wiki.videolan.org/VLC_CodeNames">"Terry Pratchett"</a> is a fixed version of 2.2.0 <a href="https://wiki.videolan.org/VLC_CodeNames">"WeatherWax"</a></div>
                    <div>It fixes numerous crashes (FLAC, SPC), codec issues (VP9, Atrac3, AAC), regressions and several issues (Resume, MP4 chapters, MKV over network) and <a href="/security/sa1501.html">security issues</a>.</div>
