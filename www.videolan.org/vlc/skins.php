 ...
 <tr>
  ...
  <td>
   <table>
    ...
    <tr>
<td><a class="skins-download" href="download-skins2-go.php?url=<?php echo "$url"; ?>">Download VLT file</a><br /> (<?php echo FormatSize( $size ); ?>. Requires VLC <?php echo $min_version; ?> or newer)
    </td></tr>
    <tr><td class="skins-comment">
      Rating:
      <?php
