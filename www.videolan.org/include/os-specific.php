<?php
   ...
   function Screenshot( $os )
    ...
    {
	$dl = array();
	$dl["Win32"] = array("/mirror.php?file=vlc/0.8.6f/win32/vlc-0.8.6f-win32.exe", "Windows (9 MB)" );
	$dl["OSX-PPC"] = array("/mirror.php?file=vlc/0.8.6f/macosx/vlc-0.8.6f-powerpc.dmg", "MacOS X PowerPC (14 MB)" );
	$dl["OSX-Intel"] = array( "/mirror.php?file=vlc/0.8.6f/macosx/vlc-0.8.6f-intel.dmg","MacOS X Intel (14 MB)" );
