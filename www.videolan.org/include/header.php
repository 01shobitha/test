      ...
      <img src='/images/paypal.png' style='float: right;' />
       <form style='clear: both; padding-top: 10p;' action="https://www.paypal.com/en_US/cgi-bin/webscr" method="post">
           <p>
               ...
               <input class='text' type='text' name="amount" value='10.00' style='background: #fff url("/images/euro.png") no-repeat 65px 2px;' />
   ...
   <div id='footer'>
      ...
      <div style='padding: 40px 10px 40px; width: 900px; margin: 0 auto;'>
         ...
         <div style='text-align: center; line-height: 17px; font-size: 12px; color: #999;'>
            ...
            Except where otherwise noted, icons and design on this site is licensed under the Creative Commons Share-Alike License v3.0 or any later version. This <b>IS not</b> for software.<br />
            The VLC cone icon was designed by Richard Øiestad.<br />
