...
<div class="container">
    <img class="img-responsive center-block" src="//images.videolan.org/images/events/vdd14.jpg" alt="VDD14 Group Picture" />

    <h1 class="bigtitle">VideoLAN Dev Days 2015<br />
    ...
    <div class="row">
        ...
        <div class="column col-xs-12 col-sm-8 col-md-9">
            ...
            <p>Like in previous years, an important number of developers from <a href="/developers/x264.html">x264</a>, <a href="http://www.ffmpeg.org/">FFmpeg</a>, <a href="http://libav.org/">Libav</a> and <a href="http://kde.org/">KDE</a> will join us as well as major industry partners! Developers, designers and anonymous people around <a href="/vlc/">VLC</a>, all of its ports to desktop, web browser environments and mobile operating systems, <a href="/projects/dvblast.html">DVBlast</a> or other multimedia projects will be there too.</p>
            ...
            <h1>Registration</h1>
            <p>Please fill out the <b><a href="http://goo.gl/forms/Kdi5LSu1u9">registration form</a></b>.</p>
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <a href="https://www.google.com/">
                        <img class="img-responsive center-block" src="/images/partners/google.png" alt="Google" />
                    </a>
                    <hr />
                    <a href="/videolan/">
                        <img class="img-responsive center-block" src="/images/logoGrey.png" alt="VideoLAN association" />
                    </a>
                    <hr />
                    <a href="http://videolabs.io">
                        <img class="img-responsive center-block" src="/images/partners/videolabs-transparent.png" alt="Videolabs SAS" />
                    </a>
                    <hr />

                    <h3>Host</h3>
                    <a href="http://www.criteo.fr/">
                        <img class="img-responsive center-block" src="/images/partners/criteo.png" alt="Criteo" />
                    </a>
                </div>
            </div>
        </div>
