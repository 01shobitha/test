...
?>
    <div>
            <center><h1 class='bigtitle' style="padding-bottom: 3px;">VLC reaches <b>2.1.1</b></h1>
            <div style="padding-top: 0px; padding-bottom: 10px; color: grey;">VLC 2.1.1 is the first minor version of our popular media player "Rincewind".</div>
            </center>
    ...
    .subtext { position: relative; top: -20px; left:300px; width: 300px; text-align: center; } 
        ...
        <h2 class="subtext" style="display: none;" id="text_5">libVLC sdk is now LGPL!</h2>
                ...
                <a id='downloadButton' href='#download' style="margin-left: 300px; margin-top: 0px;">
                    ...
                    Version <span id='downloadVersion'>2.1.1</span>
                    </span>
                </a>
                <script>
        ...
        <div class="clearme" style='padding-top: 30px;'>
            ...
            <h1 style='margin-bottom: 12px;'><?php echo _("2.1.1 Highlights"); ?></h1>
