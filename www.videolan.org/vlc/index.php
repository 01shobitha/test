<?php
   ...
   $alternate_lang = array( "an", "ar", "ast", "be", "bg", "bn_IN", "bs", "ca", "cs", "cy", "da", "de", "de_LU", "dv", "el", "en", "en_GB", "es", "et", "fa", "fo", "fr", "gd", "gl", "gu", "he", "hi", "hr", "hu", "is", "it", "ja", "km", "kn", "ko", "ky", "lt", "lv", "ml", "mr", "my", "nb", "nl", "or", "pl", "pt", "pt_BR", "ro", "ru", "si", "sk", "sl", "sr", "sv", "te", "th", "tr", "tt", "uk", "ur", "vi", "wa", "zh", "zh_TW" );
