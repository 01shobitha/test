...
may be fine.</p>
<p>Important: you must run the VLC on the server with an enabled telnet Interface to allow VLMa to deliver its streaming commands.
...
To get more information about a server, click on 'Details'. You will see its DNS and IP address. And if you have configured it on your server,
