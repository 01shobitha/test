...
<div class="container" style="max-width: 1000px !important;">
    ...
    <article>
        ...
        <p>
            ...
            gather, work, discuss and build a stronger community in Paris, France.
        </p>
    </article>
    <hr />
    ...
    <article>
        ...
        <p>
            For the sixth time, people from the VideoLAN community will meet to gather, work, discuss and build a stronger
            community. For the first time outside Paris, in Dublin, Ireland.
        </p>
        <?php image("events/vdd14.jpg" , "VideoLAN association", "center-block img-responsive"); ?>
    </article>
    <hr />
    ...
    <article>
        ...
        <p>
            <a href="/videolan/events/vdd13/">For the fifth time</a>, people from the VideoLAN community will meet in
            Paris to gather, work, discuss and build a stronger community.
        </p>
        <?php image("events/vdd13.jpg" , "VideoLAN association", "center-block img-responsive"); ?>
    </article>
    <hr />
    ...
    <article>
        ...
        <p>
            <a href="/videolan/events/vdd12/index.html">For the fourth time</a>, people from the VideoLAN community
            will meet in Paris to gather, work, discuss and build a stronger community.
        </p>
        <?php image("events/vdd12.jpg" , "VideoLAN association", "center-block img-responsive"); ?>
    </article>
    <hr />
    ...
    <article>
        ...
        <p>
            <a href="/videolan/events/vdd11.html">For the third time</a>, people from the VideoLAN community will
            meet in Paris to gather, work, discuss and build a stronger community.
        </p>
    </article>
    <hr />
    ...
    <article>
        ...
        <a href="/videolan/events/10y/">
            <?php image("10years.png", "10 cones", "center-block img-responsive") ?>
        </a>
    </article>
    <hr />
    ...
    <article>
        ...
        <p>
            <a href="/videolan/events/vdd09.html">For the second time</a>, people from the VideoLAN community
            will meet in Paris to gather, work, discuss and build a stronger community.
        </p>
    </article>
    <hr />
    ...
    <article>
        ...
        <?php image("events/vdd08.jpg" , "VideoLAN association", "center-block img-responsive"); ?>
        <p><a href="/videolan/events/20081220/VDD/">More pictures &rarr;</a></p>
    </article>
    <hr />
    ...
    <article>
        ...
        <p><a href="http://www.solutionslinux.fr/">Solutions Linux</a></p>
    </article>
    <hr />
    ...
    <article>
        ...
        <p>On February 26, TechTV aired a small <a href="http://www.techtv.com/callforhelp/freefile/story/0,24330,3509095,00.html">piece</a> on VLC media player, showing of it's powerful DVD streaming capabilities.<br />
    ...
    <article>
        ...
        back!</p>
        <?php image( "events/apple-design-award-2003.jpg" , "ADA 2003", "center-block img-responsive"); ?>
    ...
    <article>
        ...
        <p><a href="20020720/jpsaman.jpg">
                <img src="/videolan/events/20020720/jpsaman-small.jpg" class="center-block img-responsive img-thumbnail" alt="Click to see a bigger picture" width="400" height="300" />
            </a>
        </p>
