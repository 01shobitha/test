...
<td class="category"><b>Client VLC</b></td>
<td>Guide de l'utilisateur complet pour les aspects client de VLC</td>
<td class="yes">
...
<td class="category"><b>Streaming VLC</b></td>
<td>Guide de l'utilisateur complet pour les aspects serveur de VLC</td>
<td class="yes">
...
<td class="category"><b>Guide utilisateur VLS</b></td>
<td>Guide de l'utilisateur de VLS</td>
<td class="yes">
...
<td class="category"><b>FAQ VideoLAN</b></td>
<td>Questions fréquement posées à propos de VideoLAN</td>
...
<td class="yes">
<a href="/doc/misc/VLC Streaming.pdf">EN</a>
</td>
<td class="yes">
</td>
<td class="yes">
...
<p>DE = Allemand, EN = Anglais, ES = Espagnol, FR = Français, IT = Italien.</p>
...
<?php panel_start( "blue" ); ?>
 ...
 tout ce qui n'est pas dans la documentation officielle: trucs et astuces pour chaque 	 
 O.S., interface graphique, etc...</p>
<?php panel_end(); ?>

<?php panel_start( "orange" ); ?>
 <h1>Still lost?</h1>

<p>Try <a href="http://forum.videolan.org/search.php">rechercher</a> le <a href="http://forum.videolan.org">Forum</a> VideoLAN. De nombreuses informations s'y trouvent.</p>
<?php panel_end(); ?>
