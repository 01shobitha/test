...
function replaceDLinfos( )
{
    ...
    var osxDetails     = {'name': 'Mac OS X', 'size': '31&nbsp;MB', 'location': 'http://sourceforge.net/projects/vlc/files/$version/macosx/vlc-$version.1.dmg/download' };
    var osxPPCDetails  = {'name': 'Mac OS X (PPC)', 'size': '20&nbsp;MB', 'location': 'http://sourceforge.net/projects/vlc/files/$version/macosx/vlc-$version.1-powerpc.dmg/download' };
