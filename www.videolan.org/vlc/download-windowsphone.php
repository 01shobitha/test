<?php
   $title = "Official Download of VLC media player for Windows Phone";
   $new_design = true;
   $lang = "en";
...
<div class="container">
    <?php
    $screenshots = getScreenshots("windowsphone");
    $defaultDetail = getOS("windowsphone");
    ?>
        ...
        <div class="row reorder-xs">
            ...
            <div class="v-align col-sm-5">
                ...
                <div class="projectDescription hidden-sm hidden-xs">
                    <?php echo
                    _("VLC for Windows Phone plays most local video and audio files, and network streams. The app has a media library for audio and video files, a complete audio library, with metadata fetching. VLC supports multi-track audio and subtitles, speed control. VLC supports all formats of video, including, FLAC, MKV, MOV, TS and Ogg."); ?>
                </div>
                ...
                <div class="inner center-xs">
                    <div class="btn-group">
<a href="//www.microsoft.com/store/apps/vlc-for-windows-phone/9wzdncrcv5tl"><img src="http://images.videolan.org/images/windowstoredownload-en.png" border="0" /></a>
                    </div>
